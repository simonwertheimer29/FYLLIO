...
function presShim(r: any): Shim {
  const f: Record<string, unknown> = {
    ...
    "Requiere_persona": r.requiere_persona, "Motivo_quiebre": r.motivo_quiebre,
    "Intencion_propuesta": r.intencion_propuesta,
...
// El evaluador de fórmulas Airtable vive ahora en ../db/airtable-formula
// (evalFormula), compartido por todos los dominios volteados a Postgres.
...
const W: Record<string, string> = {
  ...
  "Requiere_persona": "requiere_persona", "Motivo_quiebre": "motivo_quiebre",
  "Intencion_propuesta": "intencion_propuesta",
