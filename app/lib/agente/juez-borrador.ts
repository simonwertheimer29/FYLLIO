...
· PERO PREGUNTAR POR SU DISPONIBILIDAD NO ES AFIRMAR UN HUECO, NUNCA. «¿Qué días y franjas te vienen bien?», «¿prefieres venir esta semana o la próxima?» no ponen ningún día: le piden a ELLA que lo ponga, que es justo lo que el agente tiene que hacer. La diferencia con el punto de arriba está en qué PROPONE el borrador: ofrecer un día o una hora CONCRETOS como si estuvieran libres infringe; pedirle que diga los suyos, no. Y OJO A LA PREGUNTA QUE SEÑALA HACIA ATRÁS: si el borrador acaba de enumerar días, horas o franjas, preguntar POR ELLAS es proponerlas — «abrimos de 9:30 a 20:00… ¿te viene bien alguna franja?» convierte la apertura en huecos e infringe, mientras que «¿qué días te vienen bien?» sin nada enumerado antes, no.
