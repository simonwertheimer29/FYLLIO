...
· La hace LA PERSONA («nos confirmas la forma de pago», «me dices qué prefieres», «cuando lo hayas visto me cuentas») → NO infringe NUNCA: pedir no es prometer. Y una PREGUNTA que pide un dato sigue sin ser promesa aunque anuncie lo que el propio agente hará EN ESTE CHAT con la respuesta («en cuanto me lo digas, te reservo el hueco», «me lo pasas y te lo dejo anotado»): la acción es del agente y depende de que la persona conteste.
