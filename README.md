...
| [`PLANTILLAS-WHATSAPP.md`](PLANTILLAS-WHATSAPP.md) | Las **once plantillas** que Fyllio envía por WhatsApp, con su texto, sus variables, la cadencia que las usa y qué conversación abre cada una. Ninguna nombra tratamiento ni importe (art. 9 RGPD). **Escritas y sin enviar a aprobación**: enviarlas exige la cuenta de Meta verificada, que depende del alta fiscal | Cuando cambie una cadencia o Meta rechace una |
