...
- **Evidencia** — lo que dijo una persona real de una clínica real, con nombre y fecha.
- **Interpretación** — lo que nosotros deducimos de esa evidencia.
- **No-evidencia** — intuiciones, conversaciones internas, y cualquier número que salga del seed de DEMO.
...
Solo lo que dijeron personas reales. Sin conclusiones — esas van en Interpretación, marcadas.
...
- ¿Qué PMS usáis? ¿Tiene API o exportación? ¿Expone un identificador estable de paciente? *(si no lo expone, leer de él solo sirve para consultar y la migración pasa a ser la única vía)*
...
- ¿Quién usa el producto a diario y qué edad tiene? *(calibra el tono de la comunicación)*
...
1. Añadir lo que dijeron a **Evidencia**, con nombre y fecha. Solo lo que dijeron.
